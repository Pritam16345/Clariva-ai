              ...
              <div className="flex-1 flex flex-col min-h-0 px-5">
                <div className="flex items-center justify-between mb-3 mt-4">
                  <div className="flex items-center gap-2">
                    <span className="text-[11px] tracking-[0.1em] text-[#6b7280] uppercase mt-1">Sources</span>
                ...
                {allSources.length > 1 && (
                  <motion.button
                    ...
                    className={`flex items-center gap-2 w-full px-4 py-2.5 mt-3 mb-2 rounded-[10px] border text-sm font-medium transition-all shadow-sm ${selectedSourceIds.length === allSources.length
